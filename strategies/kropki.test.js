...
import { eliminateFromConsecutiveKropkiDots, eliminateFromDoubleKropkiDots, shiftDivide, shiftMultiply, } from "./kropki.js";
QUnit.module("strategies/kropki");
QUnit.test("shiftMultiply", (assert) => {
