...
QUnit.test("select with ctrl should add", (assert) => {
...
QUnit.test("select with ctrl should remove", (assert) => {
    const selection = makeSelection(assert);
...
QUnit.test("select without ctrl should reset", (assert) => {
    const selection = makeSelection(assert);
...
QUnit.test("moving one cell should work", (assert) => {
    const selection = new Selection();
