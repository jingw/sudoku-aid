...
import { processSettings } from "./strategies/base.js";
...
export class SudokuUI {
    constructor(root) {
        this.antiknight = html.checkbox();
        this.antiking = html.checkbox();
        this.diagonals = html.checkbox();
        this.nonconsecutive = html.checkbox();
        this.digitsNotInSamePosition = html.checkbox();
        this.irregular = html.checkbox();
        this.index159 = html.checkbox();
        this.currentModeIndex = 0;
        this.textInput = document.createElement("textarea");
        const startingHighlights = [];
        for (let r = 0; r < 9; r++) {
            startingHighlights.push(new Array(9).fill(0));
        }
