...
QUnit.test("antiknight anticonsecutive", (assert) => {
...
QUnit.test("sudoku.dumpBitSet", (assert) => {
...
QUnit.test("dump verbose", (assert) => {
    const nonTrivialBoard = sudoku.emptyBoard();
    nonTrivialBoard[1][2] = sudoku.bitMask(5);
    nonTrivialBoard[1][5] = sudoku.bitMask(5) | sudoku.bitMask(6);
...
QUnit.test("eliminate naked pair", (assert) => {
    const board = sudoku.emptyBoard();
...
QUnit.test("eliminate naked triple", (assert) => {
    const board = sudoku.emptyBoard();
...
QUnit.test("row missing digit", (assert) => {
    const board = sudoku.emptyBoard();
    for (let c = 0; c < 9; c++) {
...
QUnit.test("eliminate with equality constraint", (assert) => {
    const settings = sudoku.processSettings({
        equalities: [[
                [0, 0],
                [0, 1],
...
QUnit.test("eliminate between lines known ends", (assert) => {
    const settings = sudoku.processSettings({
        betweenLines: [[
                [0, 0],
                [0, 1],
...
QUnit.test("eliminate between lines known middle", (assert) => {
    const settings = sudoku.processSettings({
        betweenLines: [[
                [0, 0],
                [0, 1],
...
QUnit.test("eliminate between lines excluded middle", (assert) => {
    const settings = sudoku.processSettings({
        betweenLines: [[
                [0, 0],
                [0, 1],
